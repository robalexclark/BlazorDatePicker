...
namespace BlazorDatePicker
{
	public class TimePickerComponentBase : PickerComponentBase
	{
		...
		[Parameter] public DateTime SelectedTime { get; set; }

		[Parameter] public bool Inline { get; set; } = false;
		[Parameter] public bool Visible { get; set; } = true;

		[Parameter] public EventCallback<DateTime> OnSelectedTimeChanged { get; set; }
		...
		{
			SelectedTime = SelectedTime.AddMinutes(MinuteStep);
			_onSelectedTimeChanged();
		}
		...
		{
			SelectedTime = new DateTime(hour, SelectedTime.Minute, SelectedTime.Second);
			ViewMode = TimeViewMode.Clock;
			_onSelectedTimeChanged();
		}
		...
		{
			SelectedTime = new DateTime(SelectedTime.Hour, minute, SelectedTime.Second);
			ViewMode = TimeViewMode.Clock;
			_onSelectedTimeChanged();
		}
