...
namespace BlazorDatePicker
{
	internal static class NodaTimeExtensionMethods
	{
		...
		/// <summary>
		/// Returns a representation of the current <see cref="Instant"/> as a <see cref="DateTimeTime"/> type in UTC.
		/// </summary>
		/// <param name="source"></param>
		/// <returns></returns>
		//internal static DateTime Now(this IClock source)
		//{
		//	if (source == null)
		//		throw new ArgumentNullException(nameof(source));

		//	return source.GetCurrentInstant().InUtc().DateTimeTime;
		//}

		///// <summary>
		///// Returns the date of the current <see cref="Instant"/> as a <see cref="DateTime"/> type in UTC.
		///// </summary>
		///// <param name="source"></param>
		///// <returns></returns>
		//internal static DateTime Today(this IClock source)
		//{
		//	if (source == null)
		//		throw new ArgumentNullException(nameof(source));

		//	return source.GetCurrentInstant().InUtc().DateTimeTime.Date;
		//}
